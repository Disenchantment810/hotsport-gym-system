...
$sql="update tbltrainers set name=:name,email=:email,mobile=:mobile,specialization=:specialization,bio=:bio where id=:trainerid";
  ...
  <body class="app sidebar-mini rtl">
   ...
   <?php include 'include/header.php'; ?>
    ...
    <?php include 'include/sidebar.php'; ?>
      <marquee onMouseOver="this.stop()" style="color: #e92f33;" onMouseOut="this.start()">Welcome to HOTSPORT GYM MANAGEMENT SYSTEM | Trainer Portal</marquee>
